...
public sealed class Record
{
    ...
    public string Field04 { get; set; } = string.Empty;
    public string Field05 { get; set; } = string.Empty;
    public string Field06 { get; set; } = string.Empty;
    public string Field07 { get; set; } = string.Empty;
    public string Field08 { get; set; } = string.Empty;
    public string Field09 { get; set; } = string.Empty;
